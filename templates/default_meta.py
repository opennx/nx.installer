...
("a",  "media_type",             0, 0, ISELECT,    0,         {FILE : "File", VIRTUAL: "Virtual"}),
("a",  "content_type",           0, 0, ISELECT,    0,         {VIDEO : "Video", AUDIO : "Audio", IMAGE : "Image", TEXT : "Text"}),
("a",  "id_folder",              1, 0, FOLDER,     0,         False),
("a",  "origin",                 0, 0, LIST,       "",        ["Import", "Acquisition", "Library", "Ingest", "Edit", "Playout 1"]),
...
("m",  "language",               1, 0, SELECT,      "en-US",  {"cs-CZ":"Czech", "en-US":"English"}),
("m",  "date",                   1, 0, DATE,        0,        False),
